...
class LuchnilkovEMaxValInColOfMatEdgeCaseTests : public LuchnilkovEMaxValInColOfMatFuncTests {};

TEST_P(LuchnilkovEMaxValInColOfMatEdgeCaseTests, EdgeCaseTests) {
  ExecuteTest(GetParam());
}
...
INSTANTIATE_TEST_SUITE_P(EdgeCaseTests, LuchnilkovEMaxValInColOfMatEdgeCaseTests, kEdgeCaseGtestValues, kPerfTestName);
